  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="cngActiveStations.jsp">
              <i class="mdi mdi-account menu-icon"></i>
              <span class="menu-title">CNG Station</span>
            </a>
         </li>
          <li class="nav-item">
            <a class="nav-link" href="bookingview.jsp">
              <i class="mdi mdi-account menu-icon"></i>
              <span class="menu-title">Bookings</span>
            </a>
          </li>          
           <li class="nav-item">
            <a class="nav-link" href="CngUpdate.html">
              <i class="mdi mdi-account menu-icon"></i>
              <span class="menu-title">CNG Update</span>
            </a>
          </li>
          <li class="nav-item">
      ...
      <!-- partial -->
		   ...
		   <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Active Stations</h4>
